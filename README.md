...
In the 'GRIPPER/mainGripper.py', you can select control signal choosing obejcts which will be scooped. $\color{red}{\textsf{Not clear when to select this object option. Is it before or after running main.py}}$
