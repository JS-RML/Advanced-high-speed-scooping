...
In the 'GRIPPER/mainGripper.py', you can select control signal choosing obejcts which will be scooped. $\color{red}{\textsf{So when to select this object option?}}$
