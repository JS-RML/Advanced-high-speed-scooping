...
$${\color{red}This sounds more like a high-level goal to achieve. Explain more explicitly the list of low-level action items that your user needs to perform.}$$ ***This sounds more like a high-level goal to achieve. Explain more explicitly the list of low-level action items that your user needs to perform.***
