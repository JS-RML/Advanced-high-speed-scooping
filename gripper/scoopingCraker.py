...
def AttackPoint1(motorDriverSerialNumber0, motorDriverSerialNumber1, motorDriverSerialNumber2, motorDriverSerialNumber3):
    ...
    odrv1.axis0.controller.input_pos = 0.005
    odrv2.axis0.controller.input_pos = 0.05
    odrv3.axis0.controller.input_pos = 0.24
...
if __name__ == "__main__":
    ...
    while(count < 100): # count 1 이 0.1 초임
        ...
        if(positionDifferenceRight[0] > 0.0035 or
            ...
            # leftFinger0.stiffness = 30
            # leftFinger1.stiffness = 30
            # rightFinger0.stiffness = 30
            # rightFinger1.stiffness = 30
