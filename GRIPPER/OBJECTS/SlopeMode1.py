...
def SlopeCard():
    ...
    # scoopingPosition = [39, 16, 26, -39] # 30
    # grabPosition = [45, 10, -35, -17] # 30
    scoopingPosition = [25, 19, 24, -36] # 15
    ...
    while(timeStep < 3):
        ...
        if encoderDifference[0] > 0.005 or encoderDifference[1] > 0.005:
            Gripper.SetStiffness([10,10,50,50])
            Gripper.SetVelocityGain([0.2, 0.2, 0.5, 0.5])
